describe('Ghost Post Creation and Publication', () => {
    ...
    it('Escenario 3: Crear un Post y asignar tags', () => {
        ...
        cy.get('p[data-koenig-dnd-droppable="true"]').first().type('contenido test 2', { force: true });
        ...
        cy.visit('http://localhost:3001/tag/tagTestPost/');
        cy.contains('Test 2').should('exist');
    ...
    it('Escenario 4: Editar un Post y Cambiar sus tags', () => {
        ...
        // Crear tags
        tags.forEach(tag => {
            cy.get('a[href="#/tags/"]').click({ multiple: true });
        ...
        // Verificar el tag en el post visitando la página
        cy.visit('http://localhost:3001/tag/tagtest1/');
    ...
    it('Escenario 5: Eliminar tag y Verificar en Post', () => {
        ...
        cy.visit('http://localhost:3001/ghost/#/tags/tagtest1');
    ...
    it('Escenario 6: Crear un Post, Publicarlo y Luego Editarlo Múltiples veces', () => {
        ...
        cy.get('p[data-koenig-dnd-droppable="true"]').first().type('contenido test multiple edits', { force: true });
        ...
        for (let i = 1; i <= 5; i++) {
            ...
            // Borrar el contenido actual y escribir el nuevo contenido
            cy.get('p[data-koenig-dnd-droppable="true"]').clear({ force: true }).type(`Contenido modificado ${i}`);
            ...
            // Navegar directamente a la URL del post actualizado
            cy.visit('http://localhost:3001/test-multiple-edits/');
    ...
    it('Escenario 7: Crear un Post y luego Agregarle Elementos Multimedia', () => {
        ...
        cy.get('p[data-koenig-dnd-droppable="true"]').first().type('contenido test multimedia', { force: true });
        ...
        // Navegar directamente a la URL del post actualizado
        cy.visit('http://localhost:3001/test-multimedia/');
    ...
    it('Escenario 8: Crear una Serie de Posts Relacionados con Tags Comunes', () => {
        ...
        posts.forEach(post => {
            ...
            cy.get('p[data-koenig-dnd-droppable="true"]').first().type('contenido '+post, { force: true });
            ...
            // Verificar el tag en el post visitando la página
            tags.forEach(tag => {
                cy.visit('http://localhost:3001/tag/'+tag+'/');
    ...
    it('Escenario 10: Crear un Post y Utilizar la Función de Vista Previa antes de Publicarlo', () => {
        ...
        cy.get('p[data-koenig-dnd-droppable="true"]').first().type(content, { force: true });
    ...
    it('Escenario 12: Crear una página estática', () => {
        ...
        cy.get('p[data-koenig-dnd-droppable="true"]').first().type('contenido test', { force: true });
        ...
        cy.visit('http://localhost:3001/contacto-test/');
    ...
    it('Escenario 13: Crear una Página y asignar tags', () => {
        ...
        // Visitar la página publicada
        cy.visit('http://localhost:3001/pagina-test-2/');
    ...
    it('Escenario 16: Modificar una Página Estática', () => {
        ...
        // Borrar el contenido actual y escribir el nuevo contenido
        cy.get('p[data-koenig-dnd-droppable="true"]').clear({ force: true }).type(newContent);
    ...
    it('Escenario 17: Eliminar tag y Verificar en Página', () => {
        // Navegar a la sección de tags
        cy.get('a[href="#/tags/"]').click({ multiple: true, force: true});
        cy.url().should('include', '/tags');
    
        // Seleccionar el tag "tagtest1" para eliminar
        cy.visit('http://localhost:3001/ghost/#/tags/tagtest6');
    ...
    it('Escenario 18: Agregar un Miembro y Revisar su Información de Participación', () => {
        ...
        cy.get('a[href="#/staff/"]').click({ multiple: true });
    ...
    it('Escenario 20: Agregar Varios Miembros y Exportar su Lista', () => {
        ...
        cy.get('button[data-test-button="staff-actions"]').click({ force: true });
    
        // Exportar lista con todos los miembros
        cy.get('span').contains('Export all staff').click({ force: true });
    });
