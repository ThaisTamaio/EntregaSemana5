Feature: Crear un post con diferentes tipos de datos inválidos en settings

@user1 @web
Scenario Outline: Como usuario un post con diferentes tipos de datos inválidos en settings 
