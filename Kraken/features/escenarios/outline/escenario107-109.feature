Feature: Crear una página con diferentes datos de entrada en titulo y contenido.

@user1 @web
Scenario Outline: Como usuario intento crear una página con diferentes datos de entrada en titulo y contenido.
